...
class MiniCourt:
    ...
    def get_mini_court_coordinates(self,
        ...
        distance_from_keypoints_x_in_pixels, distance_from_keypoints_y_in_pixels = measure_xy_distance(object_position,closest_key_point)
        # convert pixel distance to meters
        distance_from_keypoint_x_meters = convert_pixel_distance_to_meters(distance_from_keypoints_x_in_pixels,
                                                                           player_height_in_meters,
                                                                           player_height_in_pixels
                                                                           )
        distance_from_keypoint_y_meters = convert_pixel_distance_to_meters(distance_from_keypoints_y_in_pixels,
                                                                            player_height_in_meters,
                                                                            player_height_in_pixels
                                                                            )
